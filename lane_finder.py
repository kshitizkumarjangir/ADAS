...
def distortion_factors():
    ...
    # Image-points are the coresspondant object points with their coordinates in the distorted image
...
def main():
    ...
    cap = cv2.VideoCapture('testdata/video/highway/IMG_1830.MOV')  # test_sample.mp4
    ...
    out = cv2.VideoWriter('testdata/video/op.mp4', cv2.VideoWriter_fourcc(*'mp4v'), fps, (w, h))
